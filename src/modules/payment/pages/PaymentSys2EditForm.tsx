...
export default function PaymentSys2EditForm() {
    ...
    return (
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/[0.08] dark:bg-white/[0.03] sm:p-6"><div className="mb-5 border-b border-gray-100 pb-4 dark:border-white/[0.08]"><h2 className="font-semibold text-gray-900 dark:text-white">Payment details</h2><p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Modify the payment information below.</p></div>
            ...
            <div className="flex justify-end">
                ...
                <span className="inline-flex items-center gap-2"><PencilIcon className="h-4 w-4" /> Save changes</span>
                </Button>
            </div>
            </form>
        </section>
